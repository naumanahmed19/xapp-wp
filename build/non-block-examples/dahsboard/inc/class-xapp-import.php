...
class Xapp_Import_Admin {
	...
	*/
	 ...
	 * return mix
	 * */
	public function import_content_post_type_data($post_type, $contentFile) {
	...
	*/
	...
	public function install_pluginx() {
		...
		$pluginName = 'gutentor/gutentor.php';
		$pluginSlug = 'gutentor';
		...
		$plugin = plugin_basename( sanitize_text_field( wp_unslash( $pluginName ) ) );
		var_dump( is_plugin_active( $plugin ));
